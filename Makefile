...
build_alias=i386-unknown-linux-gnu
...
target_alias=pore-elf64
target_vendor=unknown
target_os=elf64
target=pore-unknown-elf64

program_transform_name = s&^&pore-elf64-&

prefix = /gsa/ausgsa/home/s/b/sbroyles/occ/OP/open-power-porebinutils/build
exec_prefix = /gsa/ausgsa/home/s/b/sbroyles/occ/OP/open-power-porebinutils/build/linux
...
TOPLEVEL_CONFIGURE_ARGUMENTS=./configure --prefix=/gsa/ausgsa/home/s/b/sbroyles/occ/OP/open-power-porebinutils/build/ --exec-prefix=/gsa/ausgsa/home/s/b/sbroyles/occ/OP/open-power-porebinutils/build/linux/ --target=pore-elf64 --build=i386-unknown-linux-gnu

tooldir = ${exec_prefix}/pore-elf64
build_tooldir = ${exec_prefix}/pore-elf64
...
BUILD_SUBDIR = build-i386-unknown-linux-gnu
# This is set by the configure script to the arguments to use when configuring
# directories built for the build system.
BUILD_CONFIGARGS =  --cache-file=../config.cache '--prefix=/gsa/ausgsa/home/s/b/sbroyles/occ/OP/open-power-porebinutils/build/' '--exec-prefix=/gsa/ausgsa/home/s/b/sbroyles/occ/OP/open-power-porebinutils/build/linux/' --program-transform-name='s&^&pore-elf64-&' --disable-option-checking --with-build-subdir="$(BUILD_SUBDIR)"
...
HOST_CONFIGARGS =  --cache-file=./config.cache  --with-gnu-as --with-gnu-ld --with-system-zlib '--prefix=/gsa/ausgsa/home/s/b/sbroyles/occ/OP/open-power-porebinutils/build/' '--exec-prefix=/gsa/ausgsa/home/s/b/sbroyles/occ/OP/open-power-porebinutils/build/linux/' --program-transform-name='s&^&pore-elf64-&' --disable-option-checking
...
TARGET_SUBDIR = pore-elf64
# This is set by the configure script to the arguments to use when configuring
# directories built for the target.
TARGET_CONFIGARGS = --cache-file=./config.cache --enable-multilib --with-cross-host=i386-unknown-linux-gnu   '--prefix=/gsa/ausgsa/home/s/b/sbroyles/occ/OP/open-power-porebinutils/build/' '--exec-prefix=/gsa/ausgsa/home/s/b/sbroyles/occ/OP/open-power-porebinutils/build/linux/' --program-transform-name='s&^&pore-elf64-&' --disable-option-checking --with-target-subdir="$(TARGET_SUBDIR)"
# This is the list of variables to export in the environment when
...
CC_FOR_TARGET=$(STAGE_CC_WRAPPER) pore-elf64-cc

# If GCC_FOR_TARGET is not overriden on the command line, then this
# variable is passed down to the gcc Makefile, where it is used to
# build libgcc2.a.  We define it here so that it can itself be
# overridden on the command line.
GCC_FOR_TARGET=$(STAGE_CC_WRAPPER) pore-elf64-gcc
CXX_FOR_TARGET=$(STAGE_CC_WRAPPER) pore-elf64-c++
RAW_CXX_FOR_TARGET=$(STAGE_CC_WRAPPER) pore-elf64-c++
GCJ_FOR_TARGET=$(STAGE_CC_WRAPPER) pore-elf64-gcj
GFORTRAN_FOR_TARGET=$(STAGE_CC_WRAPPER) pore-elf64-gfortran
GOC_FOR_TARGET=$(STAGE_CC_WRAPPER) pore-elf64-gccgo
DLLTOOL_FOR_TARGET=$$r/$(HOST_SUBDIR)/binutils/dlltool
LD_FOR_TARGET=$$r/$(HOST_SUBDIR)/ld/ld-new

LIPO_FOR_TARGET=pore-elf64-lipo
